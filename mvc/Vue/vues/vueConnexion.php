...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <?php 
        if (isset($_POST['mail']) && isset($_POST['motdepasse'])) {
            $auth = new ControleurAuth('validateAuth');
        }
    ?>
            ...
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    <form class="form-signin" name="form1" method="post">
                        ...
                        <input name="mail" id="mail" type="text" class="form-control" placeholder="Email" autofocus>
                        <input name="motdepasse" id="motdepasse" type="password" class="form-control" placeholder="Password">
